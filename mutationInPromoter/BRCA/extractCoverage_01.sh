...
somatic='/home/cliu18/liucj/projects/1.Mutation_calling_in_non-condig_region_through_EXOME/3.calling/BRCA_reanalysis/03.somatic/03.somaticForAnalysis.saveFiles/somatic_mutation_recur3_for_analysis.tsv'
...
do
	read -u6
	{
		arr=($pos)
		key="${arr[1]}\t${arr[2]}\t"
		name="${arr[1]}_${arr[2]}_${arr[3]}_${arr[4]}"
