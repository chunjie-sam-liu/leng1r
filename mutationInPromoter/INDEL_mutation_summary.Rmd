...
somatic <- as_data_frame(read.table('/home/cliu18/liucj/projects/1.Mutation_calling_in_non-condig_region_through_EXOME/4.compare_tumor_normal/INDEL/somatic.recurrency', header = F, sep = "\t"))
...
write.table(somatic5, file = "/home/cliu18/liucj/projects/1.Mutation_calling_in_non-condig_region_through_EXOME/4.compare_tumor_normal/INDEL/somatic5.recurrency",sep = "\t", quote = F, row.names = F)
